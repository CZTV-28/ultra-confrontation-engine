...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            battle_cmd::list_s1_roster,
            battle_cmd::list_s1_public_roster,
            battle_cmd::upsert_s1_roster_slot,
            battle_cmd::clear_s1_roster_slot,
            battle_cmd::get_s1_tournament,
            battle_cmd::get_s1_official_revision_package,
            battle_cmd::seed_s1_tournament_bracket,
            battle_cmd::record_s1_match_result,
